...
exports.requestValidated = (data, res) => res.status(responseStatusCode.success).json({
  status: 'SUCCESS',
  message: data,
  data: {},
});
exports.invalidRequest = (data, res) => res.status(responseStatusCode.success).json({
  status: 'FAILURE',
  message: data,
  data: {},
});
